...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 04:59 AM
...
CREATE TABLE `payment` (
  ...
  `fee` int(10) NOT NULL,
  `paid amount` int(10) NOT NULL,
  `unpaid fee` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `payment` (`PaymentID`, `ParentsID`, `StaffID`, `OwnerID`, `OutsidersID`, `PaymentStatus`, `PaymentDate`, `Status`, `fee`, `paid amount`, `unpaid fee`) VALUES
(600016, 900006, 300010, 400006, 500007, 'PAID', '2021-10-01', 'ACTIVE', 30, 300, 60),
(600017, 900007, 300011, 400007, 500008, 'OVERDUE', '2021-10-03', 'ACTIVE', 30, 270, 60),
(600018, 900008, 300012, 400008, 500009, 'PAID', '2021-10-03', 'ACTIVE', 30, 300, 60),
(600019, 900009, 300013, 400009, 500010, 'PAID', '2021-10-04', 'ACTIVE', 60, 600, 120),
(600020, 900010, 300014, 400010, 500011, 'OVERDUE', '2021-10-05', 'CANCEL', 60, 120, 600),
(600021, 900011, 300015, 400011, 500012, 'OVERDUE', '2021-10-02', 'CANCEL', 30, 0, 360);
...
INSERT INTO `ump staff parents` (`ParentsID`, `KidsID`, `PaymentID`, `UserID`, `UserName`, `Status`, `UserMaritalStatus`) VALUES
(900001, 800006, 600006, 100083, 'Abu Safwan Bin Johari', 'ACTIVE', 'Single Mom'),
(900002, 800007, 600007, 100021, 'Aiman Nasir Bin Mansor', 'ACTIVE', 'Married'),
(900003, 800008, 600008, 100023, 'Ikmal Hakimin Bin Johari', 'CANCEL', 'Married'),
(900004, 800009, 600009, 100030, 'Nur Nuha Binti Johan', 'CANCEL', 'Married'),
(900005, 800010, 600010, 100040, 'Bastisha Binti Qamal', 'ACTIVE', 'Married');
